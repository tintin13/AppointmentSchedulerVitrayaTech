...
public class LoadDataRepositoryyy {

    static final private Logger logger = LoggerFactory.getLogger(LoadDataRepositoryyy.class);
    ...
    CommandLineRunner initDatabase(AppointmentRepository appointmentRepository) {
        return args -> {
            ...
            logger.info("Preloading " + appointmentRepository.save(new Appointment(LocalDate.of(2019, 1, 10), Time.valueOf("08:00:00"),  Time.valueOf("09:00:00"),"Miklel", new BigDecimal(30))));
